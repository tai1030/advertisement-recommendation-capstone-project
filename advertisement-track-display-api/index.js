...
async function trackDisplay(cid, fid) {
    ...
    track.display = (typeof track.display === 'undefined' ? 0 : track.display) + 1;
    ...
    return await dynamodb.update({
        ...
        UpdateExpression: 'set #display = :display',
        ExpressionAttributeNames: {
            '#display': 'display',
        },
        ExpressionAttributeValues: {
